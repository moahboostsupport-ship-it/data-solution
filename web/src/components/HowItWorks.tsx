...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="mb-6 md:mb-10 scroll-mt-20">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
        {steps.map((step, index) => (
          <div
            key={step.number}
            className="bg-white rounded-2xl p-4 md:p-6 text-center card-shadow flex flex-col items-center relative"
          >
            ...
            <div className="relative mb-2 md:mb-4">
              <div
                className="w-11 h-11 md:w-14 md:h-14 rounded-full text-white flex items-center justify-center text-lg md:text-2xl font-bold"
            ...
            {/* Icon */}
            <div className="text-2xl md:text-3xl mb-1 md:mb-2">{step.icon}</div>
            ...
            {/* Description */}
            <p className="text-xs md:text-sm text-gray-500 leading-snug max-w-xs">
              {step.description}
            </p>
          </div>
        ))}
